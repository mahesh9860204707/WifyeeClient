...
public class LandlineRechargeActivity extends BaseActivity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener {


    public static final String TAG = LandlineRechargeActivity.class.getSimpleName();
    ...
    private OperatorListRequest getOperatorListRequest() {
        ...
        OperatorListRequest.rechargeType = NetworkConstant.TYPE_LAND_LINE;
    ...
    private BroadcastReceiver operatorListReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (actionOperatorList.equals(NetworkConstant.STATUS_OPERATOR_LIST_SUCCESS)) {
                ...
                if (operatorListResponse != null && operatorListResponse.operatorList.airtimeList.landlineList != null) {
                    List<OperatorDetails> operatorList = operatorListResponse.operatorList.airtimeList.landlineList.operatorDetailsList;
                    cancelProgressDialog();
    ...
    private boolean onValidate() {
        ...
        if (phoneNumber.isEmpty()) {
            showAlert(getString(R.string.landline_validation_alert_title), getString(R.string.error_empty_landline_number));
            return false;
        } else if (phoneNumber.length() < MINIMUM_PHONE_NUMBER_LENGHT
                + existPlus
                || phoneNumber.length() > MAXIMUM_PHONE_NUMBER_LENGHT
                + existPlus) {
            showAlert(getString(R.string.landline_validation_alert_title), getString(R.string.landline_validation_alert_message));
            return false;
