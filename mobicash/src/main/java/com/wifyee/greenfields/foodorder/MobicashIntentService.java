...
/**GST ON FOOD **/
   ...
   //Plan Purchase
    ...
    public static void startActionSendFoodRequest(Context context, CartFoodOderRequest cartFoodOderRequest) {
        Intent intent = new Intent(context, MobicashIntentService.class);
    ...
    private void handleActionWiFiPlansPurchase(Intent paramData) {
        ...
        try {
            ...
            jsonObject.put(ResponseAttributeConstants.MOBILE_NUMBER_PLAN,LocalPreferenceUtility.getUserMobileNumber(this));
        } catch (JSONException e) {
            Timber.e("JSONException. message : " + e.getMessage());
        }
    ...
    //Handle Deduct Wallet Balance Success
    private void handleActionDeductWalletBalance(Intent paramData) {
        ...
        try {
            ...
            jsonObject.put(ResponseAttributeConstants.ADD_WALLET_PINCODE ,madeductMoneyWalletRequest.pincode);
    ...
    private void handleActionAddWalletBalance(Intent paramData) {
        ...
        try {
            ...
            jsonObject.put(ResponseAttributeConstants.ADD_WALLET_PINCODE ,maaddMoneyWalletRequest.pincode);
...
//Handle Action Airtime Recharge Details
    private void handleActionAirtimeRecharge(Intent paramData) {
        ...
        try {
            ...
            jsonObject.put(ResponseAttributeConstants.PIN_CODE, mAirtimeRequest.pincode);
    ...
    private void handleActionGSTOnFoodorder(Intent paramData) {
       JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put(ResponseAttributeConstants.CATEGORY, "");
        } catch (JSONException e) {
            Timber.e("JSONException. message : " + e.getMessage());
        }
    ...
    private void handleActionClientLog(Intent paramData) {
        ...
        try {
            ...
            jsonObject.put(ResponseAttributeConstants.PIN_CODE, mClientLogRequest.pincode);
    ...
    private void handleActionGetClientProfileInfo(Intent paramData) {
        ...
        builder.append(mGetClientProfileInfoRequest.pincode);
        try {
    ...
    private void handleActionClientBankTransfer(Intent paramData) {
        ...
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put(ResponseAttributeConstants.TRANSFER_USER_MOBILE, mClientBankTransferRequest.clientmobile);
            jsonObject.put(ResponseAttributeConstants.TRANSFER_USER_ID, mClientBankTransferRequest.clientId);
            ...
            jsonObject.put(ResponseAttributeConstants.TRANSFER_USER_BENIFICARY_MMID, mClientBankTransferRequest.beneficiaryMMID);
    ...
    private void handleActionUploadProfilePicture(Intent paramData) {
        ...
        AndroidNetworking.upload(NetworkConstant.MOBICASH_BASE_URL_TESTING + NetworkConstant.USER_CLIENT_UPDATE_CLIENT_PROFILE_PICTURE_END_POINT)
                ...
                .addMultipartParameter(ResponseAttributeConstants.PIN_CODE, mUploadClientPictureRequest.pincode)
